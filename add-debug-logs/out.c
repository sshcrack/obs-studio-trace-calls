...
{blog(LOG_DEBUG, "obs_data_addref called with params: data: %p", data);
	if (data)
...
{blog(LOG_DEBUG, "obs_data_release called with params: data: %p", data);
	if (!data)
		return;
...
{blog(LOG_DEBUG, "obs_data_save_json called with params: data: %p, file: %s", data, file);
...
{blog(LOG_DEBUG, "obs_data_save_json called with params: data: %p, file: %s, temp_ext: %s, backup_ext: %s", data, file, temp_ext, backup_ext);
	const char *json = obs_data_get_json(data);
...
{blog(LOG_DEBUG, "obs_data_apply called with params: target: %p, apply_data: %p", target, apply_data);
...
{blog(LOG_DEBUG, "obs_data_erase called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_clear called with params: target: %p", target);
	if (!target)
		return;
...
{blog(LOG_DEBUG, "obs_data_set_default_string called with params: data: %p, name: %s, val: %s", data, name, val);
...
{blog(LOG_DEBUG, "obs_data_set_default_int called with params: data: %p, name: %s, long: no formatter for this", data, name, false);
	obs_set_int(data, NULL, name, val, set_item_def);
}

void obs_data_set_default_double(obs_data_t *data, const char *name, double val)
{blog(LOG_DEBUG, "obs_data_set_default_double called with params: data: %p, name: %s, val: %lf", data, name, val);
	obs_set_double(data, NULL, name, val, set_item_def);
}

void obs_data_set_default_bool(obs_data_t *data, const char *name, bool val)
{blog(LOG_DEBUG, "obs_data_set_default_bool called with params: data: %p, name: %s, val: %s", data, name, val);
	obs_set_bool(data, NULL, name, val, set_item_def);
}

void obs_data_set_default_obj(obs_data_t *data, const char *name, obs_data_t *obj)
{blog(LOG_DEBUG, "obs_data_set_default_obj called with params: data: %p, name: %s, obj: %p", data, name, obj);
...
{blog(LOG_DEBUG, "obs_data_set_default_array called with params: data: %p, name: %s, arr: %p", data, name, arr);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_string called with params: data: %p, name: %s, val: %s", data, name, val);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_int called with params: data: %p, name: %s, long: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_double called with params: data: %p, name: %s, val: %lf", data, name, val);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_bool called with params: data: %p, name: %s, val: %s", data, name, val);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_obj called with params: data: %p, name: %s, obj: %p", data, name, obj);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_array called with params: data: %p, name: %s, arr: %p", data, name, arr);
...
{blog(LOG_DEBUG, "obs_data_get_int called with params: data: %p, name: %s", data, name);
	return obs_data_item_get_int(get_item(data, name));
}

double obs_data_get_double(obs_data_t *data, const char *name)
{blog(LOG_DEBUG, "obs_data_get_double called with params: data: %p, name: %s", data, name);
	return obs_data_item_get_double(get_item(data, name));
}

bool obs_data_get_bool(obs_data_t *data, const char *name)
{blog(LOG_DEBUG, "obs_data_get_bool called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_get_default_int called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_get_default_double called with params: data: %p, name: %s", data, name);
	return obs_data_item_get_default_double(get_item(data, name));
}

bool obs_data_get_default_bool(obs_data_t *data, const char *name)
{blog(LOG_DEBUG, "obs_data_get_default_bool called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_int called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_double called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_bool called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_array_addref called with params: array: %p", array);
	if (array)
...
{blog(LOG_DEBUG, "obs_data_array_release called with params: array: %p", array);
	if (!array)
		return;
...
{blog(LOG_DEBUG, "obs_data_array_count called with params: array: %p", array);
...
{blog(LOG_DEBUG, "obs_data_array_push_back called with params: array: %p, obj: %p", array, obj);
	if (!array || !obj)
		return 0;
...
{blog(LOG_DEBUG, "obs_data_array_insert called with params: array: %p, idx: no formatter for this, obj: %p", array, false, obj);
	if (!array || !obj)
		return;
...
{blog(LOG_DEBUG, "obs_data_array_push_back called with params: array: %p, array2: %p", array, array2);
	if (!array || !array2)
		return;
...
{blog(LOG_DEBUG, "obs_data_array_erase called with params: array: %p, idx: no formatter for this", array, false);
	if (array) {
...
{blog(LOG_DEBUG, "obs_data_array_enum called with params: array: %p, cb: no formatter for this, param: %p", array, false, param);
	if (array && cb) {
		for (size_t i = 0; i < array->objects.num; i++) {
...
{blog(LOG_DEBUG, "obs_data_has_user_value called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_has_default_value called with params: data: %p, name: %s", data, name);
...
{blog(LOG_DEBUG, "obs_data_has_autoselect_value called with params: data: %p, name: %s", data, name);
	return data && obs_data_item_has_autoselect_value(get_item(data, name));
}

bool obs_data_item_has_user_value(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_has_user_value called with params: item: %p", item);
	return item && item->data_size;
}

bool obs_data_item_has_default_value(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_has_default_value called with params: item: %p", item);
	return item && item->default_size;
}

bool obs_data_item_has_autoselect_value(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_has_autoselect_value called with params: item: %p", item);
...
{blog(LOG_DEBUG, "obs_data_item_unset_default_value called with params: item: %p", item);
	if (!item || !item->default_size)
		return;
...
{blog(LOG_DEBUG, "obs_data_item_unset_autoselect_value called with params: item: %p", item);
	if (!item || !item->autoselect_size)
		return;
...
{blog(LOG_DEBUG, "obs_data_item_next called with params: ", );
	if (item && *item) {
...
{blog(LOG_DEBUG, "obs_data_item_release called with params: ", );
	if (item && *item) {
...
{blog(LOG_DEBUG, "obs_data_item_remove called with params: ", );
	if (item && *item) {
		obs_data_item_detach(*item);
		obs_data_item_release(item);
	}
...
{blog(LOG_DEBUG, "obs_data_item_gettype called with params: item: %p", item);
	return item ? item->type : OBS_DATA_NULL;
}

enum obs_data_number_type obs_data_item_numtype(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_numtype called with params: item: %p", item);
	struct obs_data_number *num;
...
{blog(LOG_DEBUG, "obs_data_item_set_default_array called with params: val: %p", val);
...
{blog(LOG_DEBUG, "obs_data_item_set_autoselect_array called with params: val: %p", val);
...
{blog(LOG_DEBUG, "obs_data_item_get_int called with params: item: %p", item);
	return data_item_get_int(item, get_item_data);
}

double obs_data_item_get_double(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_double called with params: item: %p", item);
	return data_item_get_double(item, get_item_data);
}

bool obs_data_item_get_bool(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_bool called with params: item: %p", item);
...
{blog(LOG_DEBUG, "obs_data_item_get_default_int called with params: item: %p", item);
	return data_item_get_int(item, get_item_default_data);
}

double obs_data_item_get_default_double(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_default_double called with params: item: %p", item);
	return data_item_get_double(item, get_item_default_data);
}

bool obs_data_item_get_default_bool(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_default_bool called with params: item: %p", item);
...
{blog(LOG_DEBUG, "obs_data_item_get_autoselect_int called with params: item: %p", item);
	return data_item_get_int(item, get_item_autoselect_data);
}

double obs_data_item_get_autoselect_double(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_autoselect_double called with params: item: %p", item);
	return data_item_get_double(item, get_item_autoselect_data);
}

bool obs_data_item_get_autoselect_bool(obs_data_item_t *item)
{blog(LOG_DEBUG, "obs_data_item_get_autoselect_bool called with params: item: %p", item);
...
{blog(LOG_DEBUG, "obs_data_set_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
	set_vec2(data, name, val, obs_data_set_obj);
}

void obs_data_set_vec3(obs_data_t *data, const char *name, const struct vec3 *val)
{blog(LOG_DEBUG, "obs_data_set_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
	set_vec3(data, name, val, obs_data_set_obj);
}

void obs_data_set_vec4(obs_data_t *data, const char *name, const struct vec4 *val)
{blog(LOG_DEBUG, "obs_data_set_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
	set_vec4(data, name, val, obs_data_set_obj);
}

void obs_data_set_quat(obs_data_t *data, const char *name, const struct quat *val)
{blog(LOG_DEBUG, "obs_data_set_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_default_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_default_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_default_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_default_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_set_autoselect_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
	get_vec2(obs_data_get_obj(data, name), val);
}

void obs_data_get_vec3(obs_data_t *data, const char *name, struct vec3 *val)
{blog(LOG_DEBUG, "obs_data_get_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
	get_vec3(obs_data_get_obj(data, name), val);
}

void obs_data_get_vec4(obs_data_t *data, const char *name, struct vec4 *val)
{blog(LOG_DEBUG, "obs_data_get_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
	get_vec4(obs_data_get_obj(data, name), val);
}

void obs_data_get_quat(obs_data_t *data, const char *name, struct quat *val)
{blog(LOG_DEBUG, "obs_data_get_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
	get_quat(obs_data_get_obj(data, name), val);
}

void obs_data_get_default_vec2(obs_data_t *data, const char *name, struct vec2 *val)
{blog(LOG_DEBUG, "obs_data_get_default_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_default_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_default_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_default_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_vec2 called with params: data: %p, name: %s, vec2: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_vec3 called with params: data: %p, name: %s, vec3: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_vec4 called with params: data: %p, name: %s, vec4: no formatter for this", data, name, false);
...
{blog(LOG_DEBUG, "obs_data_get_autoselect_quat called with params: data: %p, name: %s, quat: no formatter for this", data, name, false);
...
void obs_data_set_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second fps,
				    const char *option)
{blog(LOG_DEBUG, "obs_data_set_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, option: %s", data, name, false, option);
...
void obs_data_set_default_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second fps,
					    const char *option)
{blog(LOG_DEBUG, "obs_data_set_default_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, option: %s", data, name, false, option);
...
void obs_data_set_autoselect_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second fps,
					       const char *option)
{blog(LOG_DEBUG, "obs_data_set_autoselect_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, option: %s", data, name, false, option);
...
bool obs_data_get_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second *fps,
				    const char **option)
{blog(LOG_DEBUG, "obs_data_get_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, char: no formatter for this", data, name, false, false);
...
bool obs_data_get_default_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second *fps,
					    const char **option)
{blog(LOG_DEBUG, "obs_data_get_default_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, char: no formatter for this", data, name, false, false);
...
bool obs_data_get_autoselect_frames_per_second(obs_data_t *data, const char *name, struct media_frames_per_second *fps,
					       const char **option)
{blog(LOG_DEBUG, "obs_data_get_autoselect_frames_per_second called with params: data: %p, name: %s, media_frames_per_second: no formatter for this, char: no formatter for this", data, name, false, false);
...
{blog(LOG_DEBUG, "obs_data_item_set_frames_per_second called with params: media_frames_per_second: no formatter for this, option: %s", false, option);
...
void obs_data_item_set_default_frames_per_second(obs_data_item_t **item, struct media_frames_per_second fps,
						 const char *option)
{blog(LOG_DEBUG, "obs_data_item_set_default_frames_per_second called with params: media_frames_per_second: no formatter for this, option: %s", false, option);
...
void obs_data_item_set_autoselect_frames_per_second(obs_data_item_t **item, struct media_frames_per_second fps,
						    const char *option)
{blog(LOG_DEBUG, "obs_data_item_set_autoselect_frames_per_second called with params: media_frames_per_second: no formatter for this, option: %s", false, option);
...
bool obs_data_item_get_frames_per_second(obs_data_item_t *item, struct media_frames_per_second *fps,
					 const char **option)
{blog(LOG_DEBUG, "obs_data_item_get_frames_per_second called with params: item: %p, media_frames_per_second: no formatter for this, char: no formatter for this", item, false, false);
...
bool obs_data_item_get_default_frames_per_second(obs_data_item_t *item, struct media_frames_per_second *fps,
						 const char **option)
{blog(LOG_DEBUG, "obs_data_item_get_default_frames_per_second called with params: item: %p, media_frames_per_second: no formatter for this, char: no formatter for this", item, false, false);
...
bool obs_data_item_get_autoselect_frames_per_second(obs_data_item_t *item, struct media_frames_per_second *fps,
						    const char **option)
{blog(LOG_DEBUG, "obs_data_item_get_autoselect_frames_per_second called with params: item: %p, media_frames_per_second: no formatter for this, char: no formatter for this", item, false, false);
